...
import { LayoutDashboard, MessageSquare, Lock, LogOut, Menu, X, Bell, Settings } from 'lucide-react';
  ...
  return (
    <nav className="w-full bg-[#121214] border-b border-white/5 px-4 py-3 flex items-center justify-between relative">
      ...
      <div className="hidden lg:flex items-center gap-2">
        ...
        <Link to="/notifications" className="relative flex items-center gap-2 text-slate-400 hover:text-white px-3 py-2 rounded-xl hover:bg-[#1a1a1c] text-sm font-medium transition-all">
          <Bell size={16} />
          {unreadCount > 0 && (
        ...
        <Link to="/settings" className="flex items-center gap-2 text-slate-400 hover:text-white px-3 py-2 rounded-xl hover:bg-[#1a1a1c] text-sm font-medium transition-all">
          <Settings size={16} />
        </Link>
      ...
      {menuOpen && (
        <div className="absolute top-full left-0 right-0 bg-[#121214] border-b border-white/5 flex flex-col px-4 py-3 gap-1 z-50 lg:hidden">
          ...
          <Link to="/notifications" onClick={() => setMenuOpen(false)} className="relative flex items-center gap-2 text-slate-400 hover:text-white px-3 py-2 rounded-xl hover:bg-[#1a1a1c] text-sm font-medium">
          ...
          <Link to="/settings" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 text-slate-400 hover:text-white px-3 py-2 rounded-xl hover:bg-[#1a1a1c] text-sm font-medium">
