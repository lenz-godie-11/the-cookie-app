...
export default function Login({ setUsername, setFamilyId, theme = "dark" }) {
    ...
    >
      ...
      >
        ...
        >
          ...
          <button className="w-full bg-[#3b5d8f] hover:bg-[#2d4a73] text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 active:scale-95 transition-all mt-4">
            <LogIn size={20} /> Login
          </button>
        </form>
        <p
