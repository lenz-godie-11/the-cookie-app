    ...
    <div className="flex flex-col min-h-screen bg-[#0a0a0b]">
      ...
      <main className="flex-grow overflow-y-auto h-0">
        <Routes>
          ...
          <Route path="/chat" element={<ProtectedRoute><Chat username={username} familyId={familyId} /></ProtectedRoute>} />
          <Route path="/private-chat" element={<ProtectedRoute><PrivateChat username={username} familyId={familyId} /></ProtectedRoute>} />
          <Route path="/notifications" element={<ProtectedRoute><Notifications /></ProtectedRoute>} />
          <Route path="/settings" element={<ProtectedRoute><Settings setUsername={setUsername} setFamilyId={setFamilyId} /></ProtectedRoute>} />
        </Routes>
      </main>
      <Footer />
    </div>
